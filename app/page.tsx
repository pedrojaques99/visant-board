      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
        <div className="max-w-2xl w-full space-y-8 text-center px-4">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground">
            Where visionary brands are born.
          </p>
          <div className="flex gap-4 justify-center pt-4">
            <a
              href="/portfolio"
              className="group relative inline-flex items-center justify-center rounded-md bg-primary/90 px-6 py-3 text-sm font-medium text-primary-foreground transition-all hover:bg-primary hover:scale-105 active:scale-100"
            >
        ...
        {/* Interactive Hint */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-center opacity-60 pointer-events-none">
          <p className="text-sm text-muted-foreground animate-pulse">
            Click and drag to interact with the 3D logo
          </p>
        </div>
      </div>
    </main>
